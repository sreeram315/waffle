package com.mybatisSample.queue.mapper;
...
public interface QueueLogMapper {
    ...
    @Select("""
            ...
            VALUES (#{queue_name},
                    #{message_uuid, typeHandler = com.mybatisSample.queue.typehandler.UuidTypeHandler},
                    #{inserted_at})
            """)
    ...
    @Update("""
            ...
            WHERE message_uuid=#{message_uuid, typeHandler = com.mybatisSample.queue.typehandler.UuidTypeHandler}
            """)
